...
.controller('TuningController', ['$scope', '$http', '$rootScope', 'common', '$location', '$timeout', 'analyzeOptimizedJob', 'getOtimizedYarn',
    ...
    function($scope, $http, $rootScope, common, $location, $timeout, analyzeOptimizedJob, getOtimizedYarn) {
        ...
        /** Function for autofill all the fields from recent job*/
        ...
        /** function to set Job class defined in the jar manifest */
        ...
        /** Goes back on first page of wizard in tunning where we have jobname and select clustername */
        $scope.back = function() {
            $location.path('/add-optimized-job-configuration');
        };

        /** function for submit job with all parameters which are manadatory to display result page of tunning*/
