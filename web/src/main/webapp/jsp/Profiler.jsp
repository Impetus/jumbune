...
<div class="pageTopPane">
	<h2 class="pageTitle">Profiling</h2>
...
//For todays date;
	...
	$('.profiler-off-time').prev().html("Profiler On Time:");
					...
					function() {
						...
						$('#toggleProfilerStateFld').live('click', function() {
							...
							if (profilerState == 'TRUE') {
								...
								$('.profiler-off-time').prev().html("Profiler Off Time:");
							}
