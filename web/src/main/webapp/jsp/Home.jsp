<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<div id="mainBody">
		...
		<div class="top-wrapper" id="temp1">
			<!-- Wrapper start-->
			<div class="wrapper">
				...
				<div class="container">
					<div class="midblock">
						<div style="font-size:45px;text-align:center">Optimize Hadoop Solutions</div>

						<div class="getStar">Get Started</div>
						<p> <br />
						</p>
						<p class="last"></p>
						<div class="clear"></div>
			...
			<div class="green_block">
				<div class="wrapper" id="optionsList">
					<div class="container">

						<ul class="bottm_nav">
							<li>
								<div class="icon_block"><a id="createYamlBtn" href="javascript:void(0)"><span class="icon"><img src="skins/images/new_grey.png" /></span></a></div>
								<h3>New</h3>
								<p>Start with a new wizard to create a job</p>
							</li>
							<li>
								<div class="icon_block"><a id="uploadfiles" href="javascript:void(0)"><span class="icon"><img src="skins/images/open_grey.png" /></span></a></div>
								<h3>Open</h3>
							...
							<li>
								<div class="icon_block"><a id="yamlRepositry" href="javascript:void(0)"><span class="icon"><img src="skins/images/select_grey.png" /></span></a></div>
								<h3>Select</h3>
								<p>Select a job json from recent ones</p>
							</li>
							<li>
								<div class="icon_block"><a id="dataprofiling" href="javascript:void(0)"><span class="icon"><img src="skins/images/datapro_grey.png" /></span></a></div>
		...
		<!-- Footer start-->
<!-- 		<div class="footer" style="display:none;"><a target="_blank" href="http://jumbune.org/terms.html">Terms of Use</a></div> -->
		<!-- Footer end-->
		<footer style="background-color:#b4b2b3">
			<div>
				<div style="text-align:center"><a target="_blank" href="http://jumbune.org/terms.html"><span style="color: white;font-size: 10px;">Terms of Use</span></a></div>
			</div>
		</footer>
</div>
		<div id="yamlFormModel"></div>
		<div id="yamlRepositryModelBox" style="display:none;">
			<table id="yamlRepositryModel"></table>
		</div>
			...
			$(document).ready(function() {
					...
					$.ajax({
						...
						if (resp != null || $.trim(resp) != '') {
							...
							for (i = 0; i < yamlArr.length; i++) {
								...
								var eachJobsJsonObj = {
									"id": i + 1,
									"name": "<a href='javascript:void(0);' class='yamlJobName' rel='" + yamlArr[i] + "'>" + yamlArr[i] + "</a>"
								};
				...
				$('.yamlJobName').live('dblclick', function() {
					...
					$.ajax({
						...
						$("#yamlFormModel").load('jsp/YamlForm.jsp', {
							"populateData": resp
						}).dialog({
							dialogClass: 'modalSelectLocation',
							height: 600,
