...
/**
 * The Class ApacheFileSystem.
 */
public class ApacheDistributionFileSystem implements VirtualFileSystem {
	...
	/** The Constant LOG. */
	private static final Logger LOG = LogManager.getLogger(ApacheDistributionFileSystem.class);

	/**
	 * Instantiates a new apache file system.
	 *
	 * @param nameNodeURI the name node uri
	 * @param user the user
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	public ApacheDistributionFileSystem(String nameNodeURI, String user) throws IOException {
		try {
	...
	public VirtualFileStatus getFileStatus(String hdfsFilePath) throws IOException {
		...
		return new ApacheDistributionFileStatus(fileStatus);
