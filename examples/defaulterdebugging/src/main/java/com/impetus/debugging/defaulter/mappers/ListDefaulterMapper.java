package com.impetus.debugging.defaulter.mappers;
...
import com.impetus.debugging.defaulter.util.DefaulterConstants;


/**
 * The Mapper takes user information as input and writes <city, defaulter indicator> as output.
 * A user is defaulter if he has paid less than a sum of 10000 and if he is also a past month defaulter.
 * 
