...
public class ProfilingParam {
	 ...
	 * Sets the mapers.
	 *
	 * @param mapers the new mapers
	 */
	public void setMapers(String mapers) {
		this.mapers = mapers;
	}
	...
	public String toString() {
		return "ProfilingParam [cpu=" + cpu + ", heap=" + heap + ", mapers=" + mapers + ", reducers=" + reducers + ", masterJmxPort=" + masterJmxPort
