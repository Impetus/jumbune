...
public class AlertInfo {
	 ...
	 * @param date the date
	 */
	public AlertInfo(String level, String nodeIP, String message, String date) {
		this();
		this.level = level;
		this.nodeIP = nodeIP;
	...
	private AlertInfo(String level, String nodeIP, String message, String date, long firstOccurrence) {
		this(level, nodeIP, message, date);
		this.firstOccurrence = firstOccurrence;
	}
	
	public AlertInfo deepCopy() {
		return new AlertInfo(level, nodeIP, message, date, firstOccurrence);
	}
