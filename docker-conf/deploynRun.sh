...
java -jar /root/jumbune-dist-1.5.0-SNAPSHOT-bin.jar -Ddistribution=a -DnamenodeIP=127.0.0.1 -Dusername=root -Dpassword=8InTHtRmX0dFyfI26mKX3Q==
nohup $JUMBUNE_HOME/bin/startWeb >/dev/null 2>&1 &
sleep 2
cd $JUMBUNE_HOME/agent-distribution/
nohup java -jar jumbune-remoting-1.5.0-SNAPSHOT-agent.jar 5555 -verbose >/dev/null 2>&1 &
sleep 2
