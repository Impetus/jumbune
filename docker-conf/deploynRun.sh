...
#Deploying Jumbune
java -jar /jumbune_code/distribution/target/jumbune-dist-$JUMBUNE_VERSION-bin.jar --distribution a --namenodeIP 127.0.0.1 --username root --password 8InTHtRmX0dFyfI26mKX3Q== --influxdbhost 127.0.0.1 --influxdbport 9086 --influxdbusername admin --influxdbpassword u5zgd5kyqjtL8cVw6aq5wQ==nohup $JUMBUNE_HOME/bin/startWeb >/dev/null 2>&1 &
sleep 2
