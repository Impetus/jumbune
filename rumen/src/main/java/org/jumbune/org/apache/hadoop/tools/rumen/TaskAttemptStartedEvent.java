...
public class TaskAttemptStartedEvent implements HistoryEvent {
  ...
  private org.jumbune.org.apache.hadoop.tools.rumen.TaskType taskType;
   ...
   * @param originalTaskType Type of task
  ...
  public TaskAttemptStartedEvent( TaskAttemptID attemptId,  
		  org.jumbune.org.apache.hadoop.tools.rumen.TaskType originalTaskType, long startTime, String trackerName,
      int httpPort) {
  ...
  /** Get the task type */
  public org.jumbune.org.apache.hadoop.tools.rumen.TaskType getTaskType() {
    return taskType;
  }
  /** Get the HTTP port */
