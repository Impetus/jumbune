...
abstract class HistoryEventEmitter {
  ...
  protected static Counters parseCounters(String counters)
    ...
    try{
	    ...
	    Constructor<Counters> constructor = Counters.class.getDeclaredConstructor(new Class[]{org.apache.hadoop.mapred.Counters.class});
	    constructor.setAccessible(true);
	    Counters count= constructor.newInstance(depForm);
	    return count;
	    }catch (InstantiationException e) {
	    	 LOG.warn("InstantiationException: unable to create instance for Counters."+e);
	         return null;
		}catch (IllegalAccessException e) {
			 LOG.warn("IllegalAccessException: unable to create instance for Counters."+e);
	         return null;
		}catch (InvocationTargetException e) {
			LOG.warn("InvocationTargetException: unable to create instance for Counters."+e);
	         return null;
		}catch (NoSuchMethodException e) {
			LOG.warn("NoSuchMethodException: unable to create instance for Counters."+e);
	         return null;
		}catch (Exception e) {
			LOG.warn("Exception: unable to create instance for Counters. "+e);
			return null;
		}
  }
}
