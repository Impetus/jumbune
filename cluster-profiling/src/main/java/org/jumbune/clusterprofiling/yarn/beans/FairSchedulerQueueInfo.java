...
public class FairSchedulerQueueInfo {
	...
	private List<FairSchedulerQueueInfo> childQueues;
	...
	public List<FairSchedulerQueueInfo> getChildQueues() {
		return childQueues;
	}

	@XmlElement(name = "childQueues")
	public void setChildQueues(List<FairSchedulerQueueInfo> childQueues) {
